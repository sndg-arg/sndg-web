...
class Activities(models.Model):
    ...
    assay = models.ForeignKey('Assays', models.DO_NOTHING, related_name="activities")
    doc = models.ForeignKey('Docs', models.DO_NOTHING, blank=True, null=True, related_name="activities")
    record = models.ForeignKey('CompoundRecords', models.DO_NOTHING, related_name="activities")
...
class CellDictionary(models.Model):
    ...
    chembl = models.OneToOneField('ChemblIdLookup', models.DO_NOTHING, unique=True, blank=True)
...
class LigandEff(models.Model):
    activity = models.OneToOneField(Activities, models.DO_NOTHING)
...
class TargetComponents(models.Model):
    tid = models.ForeignKey('TargetDictionary', models.DO_NOTHING, db_column='tid', related_name="components")
    component = models.ForeignKey(ComponentSequences, models.DO_NOTHING)
...
class TargetRelations(models.Model):
    tid = models.ForeignKey(TargetDictionary, models.DO_NOTHING, db_column='tid', related_name="target_relations")
...
class ZincCompound(models.Model):
...
class ZincProperty(models.Model):
    ...
    MWT = models.FloatField(null=True)
    LogP = models.FloatField(null=True)
    Desolv_apolar = models.FloatField(null=True)
    Desolv_polar = models.FloatField(null=True)
    HBD = models.FloatField(null=True)
    HBA = models.FloatField(null=True)
    tPSA = models.FloatField(null=True)
    Charge = models.FloatField(null=True)
    NRB = models.FloatField(null=True)
